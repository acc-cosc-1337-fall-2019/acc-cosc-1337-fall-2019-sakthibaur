...
TEST_CASE("Test vector pass by reference") //test cases must have different names or they won't run
{
	std::vector<int> nums = { 99,55,1,3,66 };
...
TEST_CASE("Test for ranged loop by value: vector pass by ref") //test cases must have different names or they won't run
{
	std::vector<int> nums = { 99,55,1,3,66 };
	std::vector<int> nums_expected = { 99,55,1,3,66 };
