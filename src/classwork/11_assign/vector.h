//
template<typename T>//denotes that this class is a template, specify T (data type) at time of compiling
class Vector
{
public:
	Vector();
	...
	T& operator[](size_t i) { return nums[i]; } //overloaded subscript operator
